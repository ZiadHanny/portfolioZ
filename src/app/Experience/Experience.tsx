...
const Experience = () => {
    return (
        <section id="experience" className="relative bg-gradient-to-b from-[#0a120c] to-[#050805] text-white py-16 md:py-24 overflow-hidden">
            <div className="glow-blob w-72 h-72 bg-green-800/25 top-0 left-1/4" />
            <div className="glow-blob w-72 h-72 bg-green-500/15 bottom-0 right-1/4" />
            ...
            <div className="relative z-10 max-w-5xl mx-auto px-6 md:px-12">
                ...
                >
                    {/* Timeline line */}
                    <div className="absolute left-[7px] top-2 bottom-2 w-px bg-gradient-to-b from-green-600 via-green-400 to-transparent hidden md:block" />
                    ...
                    {experiences.map((exp, idx) => (
                        ...
                        >
                            {/* Timeline Dot */}
                            <div className="absolute -left-6 top-3 hidden md:flex items-center justify-center w-4 h-4 rounded-full bg-gradient-to-r from-green-600 to-green-400 ring-4 ring-[#050805]">
