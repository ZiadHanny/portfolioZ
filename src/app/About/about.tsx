...
const About = () => {
	...
	return (
		<section
			id="aboutme"
			className="relative py-16 px-6 md:px-12 lg:px-20 bg-gradient-to-b from-[#0B1220] via-[#111C33] to-[#0B1220] overflow-hidden"
		>
			<div className="glow-blob w-64 h-64 bg-[#111C33]/25 top-10 right-10" />
					...
					>
						{stats.map((stat, i) => (
							<motion.div
								...
								className="rounded-xl border border-white/10 bg-white/5 shadow-sm py-4 px-2 hover:border-[#00D1B2]/30 hover:shadow-lg hover:shadow-[#0B1220]/30 transition-all"
							>
